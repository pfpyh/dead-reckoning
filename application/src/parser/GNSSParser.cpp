...
auto UBXParser::find_message() const noexcept -> std::tuple<Start, End, MessageType::type>
{
...
auto UBXParser::parseNMEA(Start start, End end, GNSS& gnss) -> bool
{
